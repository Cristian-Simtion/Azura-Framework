...
<div class="scene">
	<div class="scene-content">
		...
		<div class="container pt-64">
			<div class="row">
				<div class="col text-center mt-24 mt-md-80">

					<svg class="logo-framework" width="160" height="160" viewBox="0 0 200 160">
						<path
							class="fill-primary"
					...
					<div class="text-display-m mb-24">Material Design 3 Framework</div>
					<p class="text-headline-s mb-24">CS Framework is a CSS and jQuery library with beautifully handcrafted Material Components. No design skills required — everything you need to create amazing applications is at your fingertips.</p>
			...
			<div class="row mt-24 mt-md-80 mb-80">
				...
				<div class="col md-4">
					...
					<div class="list dense">
						<ul>
							<li><span class="icon icon-dot color-error"></span>Carousels</li>
							<li><span class="icon icon-dot color-error"></span>Sortable</li>
							<li><span class="icon icon-dot color-error"></span>Filter</li>
							<li><span class="icon icon-dot color-error"></span>Parallax</li>
							<li><span class="icon icon-dot color-error"></span>Video player</li>
							<li><span class="icon icon-dot color-error"></span>Audio player</li>
							<li><span class="icon icon-dot color-error"></span>Calendars</li>
