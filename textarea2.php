...
<div class="container">
	<div class="row">
		<div class="col xs-4">
			<h1 class="text-headline-l mb-16">Fields</h1>
	...
	<div class="row">
			...
			<div class="card surface elevation-1 p-16 mb-24">
				...
				<div class="row mb-0">
					...
					<div class="col xs-4 sm-4 md-6">
						<div class="field text-field field-error">
							<div class="text-slot">
						...
						<div class="field text-field disabled">
							<div class="text-slot">
			...
			<div class="card surface elevation-1 p-16 mb-24">
				...
				<div class="row mb-0">
					<div class="col xs-4 sm-4 md-6 mb-0">
						...
						<div class="field text-field word-counter">
							<div class="text-slot">
								<input type="text" name="regular-counter">
		...
		<div class="col">
			<div class="card surface elevation-1 p-16 mb-24">
				...
				<div class="row mb-0">
					...
					<div class="col xs-4 sm-4 md-6 mb-0">
						<div class="field text-field persistent-message">
							<div class="text-slot">
		...
		<div class="col xs-4 sm-4 md-6">
			...
			<div class="field textarea-field">
				<div class="text-slot">
					<textarea type="text" maxlength="50" id="text-field-regular-1" name="text-field-regular-1" required></textarea>
					<label for="text-field-regular-1">Regular Empty</label>
				</div>
				<div class="details">
